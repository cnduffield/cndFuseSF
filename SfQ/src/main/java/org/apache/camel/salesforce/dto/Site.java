...
public class Site extends AbstractSObjectBase {
    ...
    @XStreamConverter(PicklistEnumConverter.class)
    private ClickjackProtectionLevelEnum ClickjackProtectionLevel;

    @JsonProperty("ClickjackProtectionLevel")
    public ClickjackProtectionLevelEnum getClickjackProtectionLevel() {
        return this.ClickjackProtectionLevel;
    }

    @JsonProperty("ClickjackProtectionLevel")
    public void setClickjackProtectionLevel(ClickjackProtectionLevelEnum ClickjackProtectionLevel) {
