...
public class Task extends AbstractSObjectBase {
    ...
    @XStreamConverter(PicklistEnumConverter.class)
    private RecurrenceRegeneratedTypeEnum RecurrenceRegeneratedType;

    @JsonProperty("RecurrenceRegeneratedType")
    public RecurrenceRegeneratedTypeEnum getRecurrenceRegeneratedType() {
        return this.RecurrenceRegeneratedType;
    }

    @JsonProperty("RecurrenceRegeneratedType")
    public void setRecurrenceRegeneratedType(RecurrenceRegeneratedTypeEnum RecurrenceRegeneratedType) {
